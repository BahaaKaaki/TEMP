...
107. **NEOM Authority client profile**: Selectable `neom` profile from NAFB5 deck (`22042026- NEOM Authority_NAFB5_vF.pptx`), slide 46 + master geometry (13.333x7.5in, 72px/in). Title 29,29,902x22 (20pt ALL CAPS); subtitle 29,60,902x25 (18pt ALL CAPS optional); frame 29,90,902x410. Colors `#13100D` / `#EBC03F` / `#FFFFFF`. Footer branding `NEOM AUTHORITY ACTIVATION`; logo chrome bottom-left from `backend/assets/client-templates/neom/logo.png`; bundled master at `backend/assets/client-templates/neom/default-master.pptx`.
