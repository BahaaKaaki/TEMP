...
│   │   │   ├── freestyle-shell.md          # Shell: canvas, CSS rules, layout archetypes, design principles
│   │   │   ├── freestyle-theme.md          # Theme: color tokens, fonts, contrast rules
│   │   │   └── freestyle-writing.md        # Writing: content rules, title/subtitle style, process
│   │   └── data/
