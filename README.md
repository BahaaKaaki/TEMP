...
- Slide HTML generation prompt lives in `slide-generator/src/guides/slide-html-generator-prompt.md` (Strategy& executive consulting contract: clarity, hierarchy, whitespace, non-overlapping/non-overflowing fit, shared-label reduction, explicit geometry for complex visuals, strict token-only scoped CSS)
