...
- **NEOM Authority** client profile (`neom`): NAFB5 master, slide-46 column/mandate patterns, ALL CAPS Arial 20/18pt title/subtitle, yellow `#EBC03F` headers, bottom-left logo + `NEOM AUTHORITY ACTIVATION` footer line
