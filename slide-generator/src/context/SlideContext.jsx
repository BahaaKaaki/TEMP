...
const initialState = {
  ...
  settings: {
    ...
    model: 'pwc:bedrock.anthropic.claude-opus-4-8',          // Premium slide generation (Claude Opus 4.8 on Bedrock)
    ...
    chatRouterReasoningEffort: 'high',
    ...
    pptxModel: 'pwc:bedrock.anthropic.claude-opus-4-8',
    pptxSystemPrompt: '',
    pptxCodeExample: '',
    ...
    reportModel: 'pwc:bedrock.anthropic.claude-opus-4-8',
...
function loadState() {
  try {
    ...
    if (saved) {
      ...
      // v15: Edwin V1 router planning — raise reasoning effort from low to high
      if (prevSettingsVersion < 15) {
        loadedState.settings.routerReasoningEffort = 'high';
        loadedState.settings.chatRouterReasoningEffort = 'high';
      }
